...
def game_start():
    ...
    if ginger == 'yes' or ginger == 'y':
        ...
        if step_choice == '1' or step_choice == 'left':
            ...
            print "This rock was so giant. And sadly you was a bit slow.\
            You are dead.. Take other try?"
            amount_of_lives -= 1
            game_over()
        elif step_choice == '3' or step_choice == 'still' or step_choice == 'stand':
            print "Maybe you'd miss my speech. I said the ENORMOUS GIAND ROCK\
             is FALLING onto your HEAD. You're dead OFK. So what did you expect?"
            amount_of_lives -= 1
            game_over()
        else:
